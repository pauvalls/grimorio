...
- Anchor cover to page so it fits on one A4 sheet 19) (compiler)
...
- Update changelog for v5.3.2

### Feat

- Sync grimorio-architect agent and skill to v5.3.0 (spec)
- Sync grimorio-architect agent and skill to v5.3.0 16) (spec)

## [v5.3.2] - 2026-06-22

### Docs

- Update changelog for v5.3.1

### Fix

- Detect per-install-dir version to catch stale MCP binary 15) (update)
...
- Integrate D&D 5e monster design rules (DMG cap. 9 + MM 2025) 13) (monster-engine)

### Fix

- Rewrite release-tag recipe to use shell-native variable assignment (makefile)
- Update ALL install dirs (CLI binary + MCP binary) 14) (update)
...
- Update changelog for v5.1.4

### Feat

- Sync grimorio command template to v5.2 with consolidation phase (command)

## [v5.1.4] - 2026-06-18

### Docs

- Update changelog for v5.1.3

### Feat

- Campaign consistency consolidation system 11)

### Fix

- Include binary self-update in 'grimorio update all' (update)
...
- Harden PDF compiler layout, links, images and cover page (compiler)
...
- Update README and docs for v5.1.2 PDF compiler fixes

### Fix

- Resolve PDF image verification false-negatives (compiler)
...
- Update /grimorio command to v5.1 with prologue + sequential chapters (command)
...
- PDF render fixes + WotC fidelity + remove grimorio-areas 10)
...
- Add syllable-based name generator for NPCs, characters, cities, and more 8)
- Quality, Performance, English-First & Roadmap 9) (v5.0.0)
...
- Update changelog for v4.0.20

### Feat

- Migrate PDF engine from wkhtmltopdf to Chrome/Chromium headless 5) (compiler)

## [v4.0.20] - 2026-05-25

### Docs

- Update changelog for v4.0.19

### Fix

- Handle both flat and wrapped archive structures in update all/skills (update)

## [v4.0.19] - 2026-05-25

### Docs

- Update changelog for v4.0.18

### Feat

- Add Piper TTS local voice narration for DM mode 4) (tts)

### Fix

- Disable wrap_in_directory in goreleaser to fix self-update (ci)

## [v4.0.18] - 2026-05-24

### Docs

- Update changelog for v4.0.17
- Add detailed update_narrative_state template to grimorio-dm (agent)
