	...
	tests := []struct {
	...
	}{
		{
			...
			act: Act{
				...
				Tone:              "heroic",
				RunningGuidance:   strings.Repeat("palabra ", 200), // 200 words
		...
		},
		{
			...
			act: Act{
				...
				EstimatedDuration: "2-3 sesiones",
				Tone:              "heroic",
				RunningGuidance:   strings.Repeat("palabra ", 200),
		...
		},
		{
			...
			act: Act{
				...
				EstimatedDuration: "2-3 sesiones",
				Tone:              "heroic",
				RunningGuidance:   strings.Repeat("palabra ", 450), // 450 words
				AssetHandoff:      "Objeto: mapa",
			},
			wantErr: true,
			errMsg:  "must be 150-400 words",
