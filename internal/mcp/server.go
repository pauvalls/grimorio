...
s.AddTool(mcp.NewTool("save_maps",
	...
	s.AddTool(mcp.NewTool("update_narrative_state",
		...
		mcp.WithArray("revealed_clues", mcp.Description("Clues revealed this session (strings or objects with id/description/source_act)")),
		...
		mcp.WithArray("key_decisions", mcp.Description("Key decisions made this session (strings or objects with id/description)")),
