...
func (c *Compiler) Compile(title string) (string, error) {
	...
	htmlParts = append(htmlParts, fmt.Sprintf(`<div class="cover-wrapper"><div class="cover" id="cover"><h1>%s</h1><p class="subtitle">Generated by Grimorio</p></div></div>`, html.EscapeString(title)))
...
func processImages(text string, baseDir string) string {
	...
	// Also detect bare asset references: assets/filename.ext (not inside ![...](...))
