...
```mermaid
graph TD
    Senate[El Senado Carmesí] -- Oprime --> Seekers[Los Buscadores del Sol]
    Seekers -- Intenta derrocar --> Senate
    
    Valerius[Valerius Thorne] -- Lidera --> Senate
    Kaelen[Kaelen Vance] -- Lidera --> Seekers
    
    Julian[Julian Vane] -- Vende a --> Senate
    Julian -- Suministra a --> Seekers
    
    Sylas[Sylas el Llorón] -. Ex miembro .-> Senate
    Sylas -. Fuente de info? .-> Seekers
    
    Valerius -- Desprecia --> Kaelen
    Kaelen -- Odia --> Valerius
    Kaelen -- Desconfía --> Julian
```
